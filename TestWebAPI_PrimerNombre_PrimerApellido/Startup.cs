...
using TestWebAPI_PrimerNombre_PrimerApellido.Mapper;
...
namespace TestWebAPI_PrimerNombre_PrimerApellido
{
    public class Startup
    {
        ...
        {
            services.AddDbContext<TestWebAPI_PrimerNombre_PrimerApellidoContext>(x =>
            {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "TestWebAPI_PrimerNombre_PrimerApellido v1"));
            }
